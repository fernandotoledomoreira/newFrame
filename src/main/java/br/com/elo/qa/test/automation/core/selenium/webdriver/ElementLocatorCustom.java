...
public class ElementLocatorCustom implements ElementLocator {
	...
	public ElementLocatorCustom(SearchContext searchContext, Field field, Object instance) {
		this(searchContext, new Annotations(field), field, instance);
	}

	public ElementLocatorCustom(SearchContext searchContext, AbstractAnnotations annotations, Field field,
			Object instance) {
